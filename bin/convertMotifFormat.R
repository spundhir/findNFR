...
option_list <- list(
	...
	make_option(c("-o", "--outFile"), help="output file containing motifs"),
    make_option(c("-f", "--inFormat"), default="matrix", help="format of motifs in input file (homer, jaspar, meme, transfac, uniprobe, matrix; default=%default)"),
    make_option(c("-F", "--outFormat"), default="homer", help="format of motifs in output file (homer, jaspar, meme, transfac, uniprobe, matrix; default=%default)")
)
